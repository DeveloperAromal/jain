      ...
      <section className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          <Image
            ...
            width={600}
            height={500}
            className="rounded-2xl shadow-lg lg:block md:block hidden"
            priority
          />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-4 md:grid-cols-2 gap-6">
          {courses.map((c) => (
            ...
            >
              ...
              <Link
                href={c.link}
                className="inline-block text-sm border px-3 py-1.5 rounded-lg hover:bg-bg-soft transition"
              >
                View Syllabus
              </Link>
            </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-4 md:grid-cols-2 gap-6">
          {features.map((f) => (
            ...
            >
              <f.icon className="mx-auto mb-4 h-8 w-8 text-orange-600" />
